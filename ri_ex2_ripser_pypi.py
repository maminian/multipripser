...
PH_intervals = ri.run_ripser_sim(cloud, use_ripser_pypi=True, maxdim=2)
...
max_1d_idx = np.argmax( np.diff( PH_intervals['dgms'][1], axis=1 ) )
birth,death = PH_intervals['dgms'][1][max_1d_idx]
